...
/** $VER: MIDIProcessor.h (2024.05.12) **/
...
{
public:
    static bool Process(std::vector<uint8_t> const & data, const wchar_t * filePath, MIDIContainer & container);
...
private:
    ...
    static bool ProcessRCP(std::vector<uint8_t> const & data, const wchar_t * filePath, MIDIContainer & container);
