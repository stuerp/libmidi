...
public:
    ...
    void Convert(const buffer_t & srcData, buffer_t & dstData, const char * dstType);
...
const uint8_t MT32_SYX_HDR[] = { 0x41, 0x10, 0x16, 0x12 };
const uint8_t SC55_SYX_HDR[] = { 0x41, 0x10, 0x42, 0x12 };
const uint8_t MT32_PATCH_CHG[] = { 0xFF, 0xFF, 0x18, 0x32, 0x0C, 0x00, 0x01 };
