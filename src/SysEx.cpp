    ...
    switch (_Iter[0])
    {
        ...
        case 0x00:
        {
            switch (Address)
            {
                ...
                default: Description = ::FormatText("System Parameter. Unknown address %06Xh", Address);
            }
            break;
        }
        ...
        case 0x01:
        {
            Description = ::FormatText("Temporary performance. Unknown address %06Xh", Address);
            break;
        }
        ...
        case 0x02:
        {
            Description = ::FormatText("Performance mode. Unknown address %06Xh", Address);
            break;
        }
        ...
        case 0x03:
        {
            Description = ::FormatText("Patch mode. Unknown address %06Xh", Address);
            break;
        }
            ...
            switch (Address)
            {
                ...
                default:
                {
                    switch (Address & 0xFFF0FF)
                    {
                        ...
                        case 0x404000: Description = ::FormatText("Tone Map Number %d (%s)",                            _Iter[3], IdentifyGSToneMap(_Iter[3])); break;
                        case 0x404001: Description = ::FormatText("Tone Map-0 Number %d (%s)",                          _Iter[3], IdentifyGSToneMap(_Iter[3])); break;
